...
public class MoistureThreeFragment extends Fragment {
    ...
    // UI reference
    private LineChart moistThreeChart;
    private BarChart humChart;

    public MoistureThreeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_moisture_one, container, false);
        moistThreeChart = (LineChart) v.findViewById(R.id.chartMoist1);
        initChartTemp(moistThreeChart);
        ...
        new UbidotsClient().handleUbidots(varIdMoisture3, API_KEY, new UbidotsClient.UbiListener() {
            ...
            public void onDataReady(List<UbidotsClient.Value> result) {
                ...
                LineDataSet lse = new LineDataSet(entries, "Moisture 1");
                ...
                moistThreeChart.setData(ld);
                Handler handler = new Handler(MoistureThreeFragment.this.getActivity().getMainLooper());
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        moistThreeChart.invalidate();
                    }
                });
            }
