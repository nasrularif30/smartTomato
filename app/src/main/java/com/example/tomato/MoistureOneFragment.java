...
public class MoistureOneFragment extends Fragment {
    ...
    // UI reference
    private LineChart moistOneChart;
    private BarChart humChart;

    public MoistureOneFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        moistOneChart = (LineChart) v.findViewById(R.id.chartMoist1);
        initChartTemp(moistOneChart);
        ...
        new UbidotsClient().handleUbidots(varIdMoisture1, API_KEY, new UbidotsClient.UbiListener() {
            ...
            public void onDataReady(List<UbidotsClient.Value> result) {
                ...
                moistOneChart.setData(ld);
                Handler handler = new Handler(MoistureOneFragment.this.getActivity().getMainLooper());
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        moistOneChart.invalidate();
                    }
                });
            }
